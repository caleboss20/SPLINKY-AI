    ...
    <div className=" relative flex flex-col pt-4 pl-0 gap-8 overflow-y-auto md:h-220">
      <div className="flex justify-between items-center pr-3">
        ...
        <div className="mr-2 cursor-pointer md:mr-0 ">
         ...
         <div className="w-full h-30 pl-4 flex flex-col gap-5 mb-3">
        <div 
        ...
        <div className="flex gap-2 items-center">
         ...
         onClick={deletechats}
          ...
          <span className="text-sm text-gray-300">Delete All chat</span>
        </div>
      </div>
      <div className="w-full pl-5 flex flex-col gap-5">
        {filteredChats.map((chat) => (
          ...
          >
           <div className={`${selectedChatId===chat.id? "bg-gray-800 py-2 px-4":""}`}>
